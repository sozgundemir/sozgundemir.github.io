...
Authors of ['A Recurrent Neural-Network-Based Real-Time Dynamic Model for Soft Continuum Manipulators'](https://doi.org/10.3389/frobt.2021.631303) propose an RNN-based approach to model the dynamics of soft continuum manipulator, which is scalable, can run in parallel and most importantly can predict the manipulator's shape under applied forces and torques in real-time.
